...
public class InitBDD {
	...
	private void init() throws IOException, ContactManagerException{
		...
		if ("create".equals(properties.getProperty("spring.jpa.hibernate.ddl-auto"))) {
			...
			Client eni = new Client("ENI Ecole Informatique", "Ecole qui forme aux métiers de l'informatique en continu ou en alternance");
			clientManager.add(eni);
			...
			contactManager.addComment(c1, alex);
			contactManager.addComment(c2, alex);
